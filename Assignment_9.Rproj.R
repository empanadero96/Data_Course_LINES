...
read_csv(file = "Data/GradSchool_Admissions.csv")

# save it as a dataframe

df <- read_csv(file = "Data/GradSchool_Admissions.csv")
...
# compare performace, as learned in week 10
...
rmarkdown::render("Assignment_9.R")
